...
import br.com.douglasfernandes.console.models.ConsoleGrid;
...
public class DataTransmitterImpl implements DataTransmitter{
	 ...
	 */
	protected Discoverer selected = null;
	
	/**
	 * Lista contendo o estado final de cada sonda após execução dos comandos (resultados).
	 */
	protected ArrayList<Discoverer> commandsResult;
	
	/**
	 * Construtor principal da classe.
	 */
	public DataTransmitterImpl() {
		this.grid = null;
	 ...
	 * </ul>
	 */
	protected CommandType getCommandType(String command) {
	 ...
	 * @return
	 */
	protected ArrayList<String> getMoves(String command) {
	 ...
	 */
	protected boolean isRotationCommand(String command) {
	...
	public void createGrid(int X, int Y) {
		if(X == Y) {
			this.grid = new ConsoleGrid(X);
		}
		else {
			this.grid = new ConsoleGrid(X, Y);
		}
	}
